// Gerado para importação no FormBuilder quando a UI aceita apenas .ts/.tsx
// Exporta o JSON do formulário como um módulo TS para facilitar import.
const menuAdminForm = {
  ...
  "metadata": {
    "notes": "Importar este JSON no FormBuilder Editor ou usar como referência para implementação do TSX. Os endpoints devem existir no backend para listar usuários, grupos e itens de menu e para persistir user_menu_config."
  }
};
