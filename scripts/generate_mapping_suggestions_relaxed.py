...
def main():
    ...
    plan_out='database/PLANILHA_LONG_AUTO_MAPPED_RELAXED.csv'
    sug_out='reports/mapping_suggestions_relaxed.csv'
    ...
    with open(plan_in, newline='', encoding='utf-8', errors='replace') as fin, \
        ...
        for r in reader:
            ...
            # heuristics: if jaccard >= 0.30 apply
            if best_score >= 0.30:
    ...
    print(f"Relaxed applied: {len(applied)} -> {plan_out}; suggestions: {sug_out}")
